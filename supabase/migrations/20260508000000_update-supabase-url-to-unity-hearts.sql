-- Update all trigger functions to point to the new Supabase project (unity-hearts).
-- Replaces every hardcoded reference to the old project URL (nyhlwamvqjmaxpmqxzah)
-- with the new one (qclefndzismozdogsfot).
